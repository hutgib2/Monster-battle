...
def folder_importer(*path):
    ...
    for folder_path, _, file_names in walk(join(*path)):
        for file_name in file_names:
            ...
            surfs[file_name.split('.')[0]] = pygame.transform.smoothscale(surf, (surf.get_width()*2, surf.get_height()*2)).convert_alpha()
    return surfs
    ...
    for folder_path, _, file_names in walk(join(*path)):
        for file_name in file_names:
            ...
            for col in range(cols):
                ...
                cutout_surf = pygame.transform.smoothscale(cutout_surf, (cutout_surf.get_width()*2, cutout_surf.get_height()*2))
